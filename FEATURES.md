...
- ✅ **Offline routing — fully on-device (built + device-verified 2026-06-30; goes live when region graphs are published).**
  ...
  ≈ 21 MB from a manifest). On-device end-to-end verified (Pixel 5a): downloaded Sacramento metro → offline →
  21.8 mi route via NE 45th St with named steps + a correct 28-min ETA. Pure JVM (GraphHopper runs on ART
