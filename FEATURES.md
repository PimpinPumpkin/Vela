...
- ✅ **Downloading the area on screen says what it costs first (2026-09-25, issue #609).** "Download the area you're viewing" opens a confirmation with the estimated size of the view itself and, as a separate choice you can untick, the whole region around it (offline directions, places and the region's map), which only comes as a whole region and used to download silently.
