...
- ✅ **Spoken and typed commands** (discussion #365, 2026-09-13): "take me home", "get me to work", "navigate to the station", "Davis to San Francisco", "nearest pharmacy" and "what is my ETA" are understood as actions in English, French, German, Spanish, Italian, Portuguese and Dutch, with English as the fallback everywhere; anything unrecognised is a plain search. On-device rules, no server.
