...
- ✅ **Car-mode strips water/park/neighbourhood titles too (2026-07-17).** River names, lake
  labels and hamlet/neighbourhood titles joined the drive-nav declutter list - every basemap
  symbol re-places on camera rotation and nav rotates every frame, so labels nobody reads
  mid-drive are pure collision work. Town, city and state names stay for orientation, as Google
  keeps them. Walking and biking keep everything, as before.
