...
- ✅ **The exit you take wears a green callout (2026-09-17)** - while navigating, the exit your route leaves at gets a green bubble with its number, in the language of the signs on the road; the exits you drive past keep the basemap's own shields. The number is read out of the maneuver ("Take exit 528 toward ..."), including the phrasings other languages use.
...
- ✅ **Street callouts skip the spots with no room (2026-09-17)** - a cross-street bubble that cannot clear the road you are driving, on either side, is not drawn at all.
