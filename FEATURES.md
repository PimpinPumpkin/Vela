...
- 🟡 **Avoid tolls / avoid highways** - sticky chips in the route chooser (drive). Honoured by downloaded region graphs once they are rebaked with the avoid profiles (the public OSRM rejects exclude, so online falls back to a normal route); plumbing + graph builder shipped 2026-07-11
