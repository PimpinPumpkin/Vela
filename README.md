...
| Photo gallery | Light theme - map | Light theme - place |
|:-:|:-:|:-:|
| <img src="docs/screenshots/07-gallery.png" width="150"> | <img src="docs/screenshots/08-map-light.png" width="150"> | <img src="docs/screenshots/09-place-light.png" width="150"> |
...
- **Real turn-by-turn navigation.** Spoken directions from a neural voice that runs
  ...
  🔊 **[Hear the nav voice](docs/voice-demo.mp4)** - one tap to a player with the
  actual in-app voice (HFC Female at the default pace), generated by the same
  engine the app runs on the phone.
