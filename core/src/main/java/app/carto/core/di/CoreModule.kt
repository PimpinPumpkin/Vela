package app.carto.core.di

import app.carto.core.CartoConfig
import app.carto.core.data.MapDataSource
import app.carto.core.data.MockMapDataSource
import app.carto.core.data.google.GoogleMapsDataSource
...
object CoreModule {
     ...
     * before any Google calibration; flip [CartoConfig.USE_GOOGLE_SOURCE] once
    ...
    ): MapDataSource = if (CartoConfig.USE_GOOGLE_SOURCE) google else mock
}
