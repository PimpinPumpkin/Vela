 ...
 * matched word-by-word. So "W Covell Blvd", "W Covell Blvd" and "W Covell Blvd" all hit the same
...
class OfflineAddressStore @Inject constructor(
     ...
     * name within [REV_STREET_M] ("on Russell Street SE"), else null. Bounded by a small lat/lng box so it
