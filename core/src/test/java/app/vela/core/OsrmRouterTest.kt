...
class OsrmRouterTest {
    ...
    @Test fun phrasesReadNaturally() {
        assertEquals("Turn right onto Russell Blvd", RouteGeometry.osrmPhrase("turn", "right", "Russell Blvd", null))
        assertEquals("Continue onto 5th St", RouteGeometry.osrmPhrase("new name", "straight", "5th St", null))
