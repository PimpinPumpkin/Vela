...
class SearchParserHoursTest {
    ...
    fun stripsBusinessNamePrefixFromAddress() {
        assertEquals("1451 W Covell Blvd, Sacramento, WA 95616",
            SearchParser.stripNamePrefix("Safeway, 1451 W Covell Blvd, Sacramento, WA 95616", "Safeway"))
        ...
        // street merely named after the place would be beheaded ("Plaza, …" / "Access Rd, Sacramento").
        assertEquals(
            "Safeway Plaza, 1451 W Covell Blvd",
            SearchParser.stripNamePrefix("Safeway Plaza, 1451 W Covell Blvd", "Safeway"),
        )
        assertEquals("Boeing Access Rd, Sacramento", SearchParser.stripNamePrefix("Boeing Access Rd, Sacramento", "Boeing"))
