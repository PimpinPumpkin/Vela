#!/usr/bin/env bash
# D1 regression (2026-07-08): "Choose on map" must open ALREADY drivable — the center map target
...
assert_focus_ytop_between 190 260 "center map target auto-focused in pick mode"
